...
export const CATEGORIES = [
  ...
  {
    id: "almofadas-bones",
    name: "Almofadas e Bonés",
    description: "Almofadas decorativas e bonés personalizados",
    idealFor: "Brindes, merchandising e uniformes",
    tags: ["Versatilidade", "Alta visibilidade", "Personalização total"],
    image: "/placeholder.svg",
  },
  {
    id: "copos-garrafas",
...
export const FAQS = [
  ...
  },
  {
    ...
    answer: "Sim! Emitimos nota fiscal para todos os pedidos. Somos uma fábrica regularizada com mais de 30 anos de mercado.",
  },
  {
...
export const CATEGORY_FILTERS: Record<string, { intentions: string[]; type: string }> = {
  ...
  "camisa-polo": { intentions: ["empresa", "premium"], type: "vestuario" },
  "camisa-social": { intentions: ["empresa", "premium"], type: "vestuario" },
  "moletom-careca": { intentions: ["empresa", "brinde", "premium"], type: "vestuario" },
  ...
  "almofadas-bones": { intentions: ["brinde", "evento"], type: "acessorios" },
